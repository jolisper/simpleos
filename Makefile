...
BIN_DIR=bin
X86_64_DIR=x86_64
FILES = $(BUILD_DIR)/kernel.asm.o $(BUILD_DIR)/kernel.o $(BUILD_DIR)/idt/idt.asm.o $(BUILD_DIR)/idt/idt.o $(BUILD_DIR)/memory/memory.o $(BUILD_DIR)/io/io.asm.o $(BUILD_DIR)/memory/heap/heap.o $(BUILD_DIR)/memory/heap/kheap.o $(BUILD_DIR)/memory/paging/paging.o  $(BUILD_DIR)/memory/paging/paging.asm.o
INCLUDES=-I./src
...
$(BUILD_DIR)/memory/heap/heap.o: ./src/memory/heap/heap.c
	i686-elf-gcc $(INCLUDES) -I$(SRC_DIR)/memory/heap $(FLAGS) -std=gnu99 -c $(SRC_DIR)/memory/heap/heap.c -o $(BUILD_DIR)/memory/heap/heap.o

$(BUILD_DIR)/memory/heap/kheap.o: ./src/memory/heap/kheap.c
	i686-elf-gcc $(INCLUDES) -I$(SRC_DIR)/memory/heap $(FLAGS) -std=gnu99 -c $(SRC_DIR)/memory/heap/kheap.c -o $(BUILD_DIR)/memory/heap/kheap.o

$(BUILD_DIR)/memory/paging/paging.o: ./src/memory/paging/paging.c
	i686-elf-gcc $(INCLUDES) -I$(SRC_DIR)/memory/paging $(FLAGS) -std=gnu99 -c $(SRC_DIR)/memory/paging/paging.c -o $(BUILD_DIR)/memory/paging/paging.o

$(BUILD_DIR)/memory/paging/paging.asm.o: $(SRC_DIR)/memory/paging/paging.asm
	nasm -f elf -g $(SRC_DIR)/memory/paging/paging.asm -o $(BUILD_DIR)/memory/paging/paging.asm.o

outdir:
	mkdir -p $(BUILD_DIR) 
	mkdir -p $(BUILD_DIR)/idt 
	mkdir -p $(BUILD_DIR)/memory/heap 
	mkdir -p $(BUILD_DIR)/memory/paging
